...
sub generate_form {
	...
	my ($form_action, $sub_record_dt, $sub_record_child, @possible_types, $action_arg, $field, $form_counter, $need_new_parent, $new_parent_string, $p, $send_data_code, $sub_record, $subdata_object, $subdata_type, $use_params_key, $row_name);
