...
sub options_perl_module {
    ...
    foreach $core_class ('standard_delete','standard_data_actions','singleton_data_actions','subform_data_actions','basic_data_view','view_details','basic_calendar','call_named_method','button_menu') {
